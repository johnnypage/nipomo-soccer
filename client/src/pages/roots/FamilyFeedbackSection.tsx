...
const SURVEY_TABS = [
  {
    ...
    plan: [
      "Preseason clinics before every season with session plans provided.",
      "All coach training and certifications covered by Nipomo Soccer.",
  ...
  },
  {
    ...
    plan: [
      "All new equipment purchased for this season.",
      "Improved jersey quality.",
...
export default function FamilyFeedbackSection() {
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        <div>
          ...
          <p className="text-warmwhite/55 mt-2 text-[17px]">
            ...
            the big takeaways and how we plan to address them this year.
          </p>
        </div>
        ...
        <div className="roots-survey-grid">
