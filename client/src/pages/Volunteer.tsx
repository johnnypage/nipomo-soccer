...
const ROLE_GROUPS: RoleGroup[] = [
  {
    ...
    roles: [
      {
        id: "president",
        title: "President of Nipomo Soccer",
        desc: "Leads the organization, sets direction, and is ultimately accountable for everything that happens on and off the field.",
        time: "Ongoing",
        timeShort: "Ongoing",
        status: "filled",
        filledBy: { name: "Adrian Dalton", since: "2023", initials: "AD", photo: "/adrian-dalton.jpg", photoPosition: "center top" },
        summary: "The President leads Nipomo Soccer's board, sets organizational direction, and is the face of the club in the community.",
        responsibilities: [
          "Lead the board of directors and ensure the organization operates with integrity",
          "Set the strategic direction of the club season to season",
          "Represent Nipomo Soccer with Cal South, local schools, city, and community partners",
          "Make final calls on policy, personnel, and program decisions",
          "Support all coordinators and ensure leadership team is functioning well",
        ],
        worksWith: "All board members, Program Director, Cal South",
        goodFit: "Strong leader, community-oriented, calm under pressure.",
      },
      {
        id: "program-director",
